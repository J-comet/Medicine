...
import hs.project.medicine.databinding.LayoutMainHomeView22Binding;
...
public class MainHomeView22 extends ConstraintLayout implements View.OnClickListener {

    private LayoutMainHomeView22Binding binding;
    private Context context;
    private GridUserAdapter userAdapter;
    private ArrayList<User> userArrayList;

    public MainHomeView22(@NonNull Context context) {
        super(context);
        this.context = context;
        initView(context);
    }

    public MainHomeView22(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        initView(context);
    }

    public MainHomeView22(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.context = context;
        initView(context);
    }

    public MainHomeView22(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    private void initView(Context context) {
        binding = LayoutMainHomeView22Binding.inflate(LayoutInflater.from(context), this, true);
        setupUI();
    }
